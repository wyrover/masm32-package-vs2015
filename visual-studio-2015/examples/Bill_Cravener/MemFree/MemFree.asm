...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	; this structure is already defined in windows.inc therefor the name prefixed with 'S'
	; otherwise we get a non-benign structure redefinition error.
    SMEMORYSTATUSEX STRUCT					
       dwLength           DWORD ?
       dwMemoryLoad       DWORD ?

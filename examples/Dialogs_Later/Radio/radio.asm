...
create_dialog proc iinstance:DWORD,extra:DWORD
  ...
  ; -----------------------------------------------------------------------
    ...
    DlgRadio " Radio Button 1",BS_LEFT or WS_TABSTOP,20,15,65,12,101
    DlgRadio " Radio Button 2",BS_LEFT or WS_TABSTOP,20,30,65,12,102
    DlgRadio " Radio Button 3",BS_LEFT or WS_TABSTOP,20,45,65,12,103
    DlgRadio " Radio Button 4",BS_LEFT or WS_TABSTOP,20,60,65,12,104
